    ...
    <DashboardLayout>
      <div className="min-w-0 space-y-5 sm:space-y-7">
        <section className="rounded-3xl bg-slate-950 p-4 text-white shadow-2xl sm:rounded-[2rem] sm:p-8">
          ...
          <h1 className="mt-4 text-2xl font-black sm:text-5xl">Your planned travel library.</h1>
        ...
        {trips.length === 0 ? (
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            {trips.map((trip) => (
              <div key={trip.id} className="min-w-0 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
